...
```
# Prelude  
Well, why `git`and `GitHub` at the very beginning? I want you to be able to interact with me for all the lessons, take part in the discussion and make you competent with basic tasks (`push`and `pull`). You actually need 4-5 lines of code to push and pull. And associate bash alternative to Windows graphical user interphase (clicking). Just get used to these stuffs. You will get the feeling of accomplishment everyday. You know what, people get demotivated just because they don't get the feeling of accomplishment. I am here holding your hands. Don't afraid to tinker and ponder around. You can push the codes/scripts from the classes or your own practice codes. You will FEEL better and stronger after a bit of hustling!
...
Think of family tree, it is exactly the same. Try to associate.  
...
8. Optional: Navigate your other folders as well. Catch the logic of navigation. Also, can you make a list of words I used alternatively (back and forth) and maybe add them in one of your repo again? For example, folder and directory are the same thing; similarly, `HOME` and root are the same.   
  
9. Share your repos with me (email me by Friday 10PM BD Time). I need time to check, right?
