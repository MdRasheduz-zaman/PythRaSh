...
## 🏡 Homework: Factors, Subsetting, and Biological Insight
...
10. Simulate expression data for 3 tissues:
...
::: callout-note
**Hint:**
Variability is expressed in another way (squaring) of measuring standard deviation (`sd`). Now, do you see how to use `sd` inside `tapply()` function?
:::
...
```
::: callout-note
Do you see the point how you would use the `elseif` loop if you wanted to write a function to make 4 or 5 categories? If not, pause and re-think. You need to see the point. 
